        ...
        "options": {
          "scales": {
            "xAxes": [{
              "scaleLabel": {
                "display": true,
                "labelString": '6-Month Range | Kanabot -GlennR',
              },
              "type": "time",
              "time": {
                "parser": "MM-DD-YYYY",
      ...
      "options": {
        "scales": {
          "xAxes": [{
            "scaleLabel": {
              "display": true,
              "labelString": 'Hours UTC 00:00 | Kanabot -GlennR',
            },
            "type": "time",
               "time": {
      ...
      "options": {
        "scales": { 
          "xAxes": [{
              "scaleLabel": {
                "display": true,
                "labelString": '7-Day Range | Kanabot -GlennR',
              },
            "type": "time",
            "time": {
              "parser": "MM-DD-YYYY",
    ...
    var conf = { 
      ...
      "options": {
        "scales": {
          "xAxes": [{ "scaleLabel": {
            "display": true,
            "labelString": '1-Month Range | Kanabot -GlennR',
             },
            "type": "time",
            "time": {
              "parser": "MM-DD-YYYY",
